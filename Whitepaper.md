...
Tokens are distributed in the ratio of 6:2:2 among Liquidity Pool, Protocol Developers and Treasury. There will be no tokens minted until the end of epoch.
...
Max supply cap = 10,000 Utility token per epoch <br>
Decimals = 12<br>
1 epoch = 1 week = 1 cycle<br>
Minting phase = 2 (Initial & Live phases)<br>
...
<i><b>Utility Token Treasury</i></b><br>
Certain amount of Utility Token in each epoch goes to treasury, which can be used for the growth of the community and to cover expenses such as grants,operating cost, marketing, development, etc.

Utility Token Treasury = 0.2\* Tokens to be minted in that epoch Utility Token <br>
